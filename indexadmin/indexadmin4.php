...
<html>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
         ...
         <?php
            $SQL = "SELECT candidato, cantidadVotos FROM candidatosconcejal";
  ...
  <body>
    ...
    <div class="d-flex justify-content-center">
      <div class ="p-2"><a style= "text-align: right" href="indexadmin3.php"  class="btn btn-secondary">Volver</a></div>
