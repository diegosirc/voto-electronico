...
<html>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
         ...
         <?php
            $SQL = "SELECT candidato, cantidadVotos FROM candidatoslegislador";
        ...
        var options = {
          title: 'Resultados de Legislador'
        };
  ...
  <body>
    ...
    <div id="piechart" style="width: 900px; height: 500px;"></div>
      ...
      <div class ="p-2"><a style= "text-align: right" href="indexadmin1.php"  class="btn btn-secondary">Volver</a></div>
      <div class="p-2"><a style= "text-align: right" href="indexadmin3.php"  class="btn btn-secondary">Siguiente</a></div>
