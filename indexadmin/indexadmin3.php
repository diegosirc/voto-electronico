...
<html>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
         ...
         <?php
            $SQL = "SELECT candidato, cantidadVotos FROM candidatosintendentes";
        ...
        var options = {
          title: 'Resultados de Intendente'
        };
  ...
  <body>
    ...
    <div class="d-flex justify-content-center">
      <div class ="p-2"><a style= "text-align: right" href="indexadmin2.php"  class="btn btn-secondary">Volver</a></div>
      <div class="p-2"><a style= "text-align: right" href="indexadmin4.php"  class="btn btn-secondary">Siguiente</a></div>
