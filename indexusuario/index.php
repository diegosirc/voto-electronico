...
$query="SELECT lista,partido,Candidato, cantidadVotos, ID  FROM candidatosgobernador";
    ...
    <div class="container">
                        ...
                        $(document).ready(function() {
                            ...
                            $('#mi-boton').on('click', function() {
                                if ($('input[type="radio"]').is(':checked')) {
                                    console.log("El radio button está seleccionado");
                                        } else {
                                            console.log("El radio button no está seleccionado");
                                        }
                                //alert("Debe seleccionar un candidato si o si");
                            });
        ...
        function guardar(id,votos){
            ...
            $.ajax({
                ...
                type: 'GET',
                data: {id: id, vota:votos, candidatura: 'gobernador'},
                ...
                <a style= "text-align: right" href="index2.php#"  class="btn btn-secondary" id="mi-boton">Siguiente</a>
