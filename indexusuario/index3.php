...
$query="SELECT lista,partido,Candidato, cantidadVotos, ID  FROM candidatosintendentes";
    ...
    <div class="container">
        ...
        function guardar(id,votos){
            ...
            $.ajax({
                ...
                type: 'GET',
                data: {id: id, vota:votos, candidatura: 'intendentes'},
                ...
                <a style= "text-align: right" href="index4.php#"  class="btn btn-secondary">Siguiente</a>
