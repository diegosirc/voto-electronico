...
$query="SELECT lista,partido,Candidato, cantidadVotos, ID  FROM candidatoslegislador";
    ...
    <div class="container">
        ...
        function guardar(id,votos){
            ...
            $.ajax({
                ...
                type: 'GET',
                data: {id: id, vota:votos, candidatura: 'legislador'},
                ...
                <a style= "text-align: right" href="index3.php#"  class="btn btn-secondary">Siguiente</a>
